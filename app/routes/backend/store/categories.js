...
const MainModel 	= require(__path_models + 'categoriesStore');
const MainValidate	= require(__path_validates + 'categoriesStore');
...
router.get('/delete/:id', (req, res, next) => {
	...
	MainModel.deleteItem(id, {task: 'delete-one'} ).then((result) => {
		req.flash('success', NotifyHelpers.DELETE_SUCCESS);
