...
const MainModel 	= require(__path_models + 'articleStore');
const CategoryModel = require(__path_models + 'categoriesStore');
const MainValidate	= require(__path_validates + 'articleStore');
...
const linkIndex		 = '/' + systemConfig.prefixAdmin + `/store/${controllerName}/`;
...
const folderLink 	 = 'public/uploads/articleStore/';
